...
The repository includes a GitHub Actions workflow that automatically builds all components on every push. The workflow builds both Debug and Release configurations and creates artifacts for distribution.
